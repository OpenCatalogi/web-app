export const nl = {
  ...
  Contact: "Contact",
  "Submit component": "Component indienen",
  "Register your component": "Meld uw component",
  "Repository url of your component": "Geef de url van de repository van uw component op",
};
