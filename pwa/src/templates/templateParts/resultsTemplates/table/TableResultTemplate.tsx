          ...
          components.map((component) => (
            ...
            >
              ...
              <TableCell>
                ...
                >
                  <DataBadge data-tooltip-id={TOOLTIP_ID} data-tooltip-content={t("Layer")} className={styles.tagWidth}>
              ...
              <TableCell>
                <DataBadge data-tooltip-id={TOOLTIP_ID} data-tooltip-content={t("Sources")} className={styles.tagWidth}>
                  {_.upperFirst(
