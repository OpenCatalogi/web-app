...
export const UsageDocumentationTemplate: React.FC = () => {
	return (
		<Container layoutClassName={styles.container}>
          ...
          &ldquo; Use this template &rdquo; knop op de <br />
					<span onClick={() => open("https://github.com/ConductionNL/skeleton-app")}>
						<Link icon={<ExternalLinkIcon />} iconAlign="start">
              GitHub-pagina
						</Link>
					</span>
          . Vertel GitHub waar je je prototype wilt hebben draaien en klik op &ldquo; Create a repository from template
          &rdquo;.
					<br />
					<br />
				</Paragraph>
          ...
          &ldquo; serve &rdquo; commando. <CodeBlock codeBlock={"$ mkdocs serve"} /> Ga naar de lokale repository en
          voer het commando uit om de documentatie beschikbaar te stellen op poort:8000. <br />
