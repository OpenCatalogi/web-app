    ...
    <Container layoutClassName={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <Paragraph className={styles.description}>
          ...
          <span>
            <Link target="_new" to="https://yml.publiccode.tools/schema.core.html#top-level-keys-and-sections">
          ...
          <span>
            <Link target="_new" to="https://publiccode-editor.developers.italia.it/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              hier
        ...
        <Paragraph className={styles.description}>
          ...
          <span>
            <Link target="_new" to="https://componentencatalogus.commonground.nl/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
          ...
          ,{" "}
          <span>
            <Link target="_new" to="https://developer.overheid.nl/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              Developer Overheid
          ...
          en <br />
          <span>
            <Link target="_new" to="https://www.softwarecatalogus.nl/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
      ...
      <section className={styles.section}>
        ...
        <Paragraph className={styles.description}>
          ...
          <span>
            <Link target="_new" to="https://github.com/ConductionNL/skeleton-app">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              GitHub-pagina
        ...
        <Paragraph>
          ...
          <span>
            <Link target="_new" to="http://localhost:81/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              http://localhost:81/
          ...
          <span>
            <Link target="_new" to="https://docs.conductor-gateway.app/en/latest/installation/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              common-gateway
        ...
        <Paragraph className={styles.description}>
          ...
          <span>
            <Link target="_new" to="https://kubernetes.io/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              kubernetes
          ...
          <span>
            <Link target="_new" to="https://helm.sh/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              Helm
          ...
          <span>
            <Link target="_new" to="https://dashkube.com/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              Dashkube
          ...
          of{" "}
          <span>
            <Link target="_new" to="https://rancher.com/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              Rancher
          ...
          <span>
            <Link target="_new" to="https://helm.sh/docs/intro/install/#through-package-managers/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              helm.sh
          ...
          <span>
            <Link target="_new" to="https://kubernetes.io/docs/tasks/tools/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              kubectl
        ...
        <Paragraph>
          ...
          <span>
            <Link
              target="_new"
              to="https://github.com/OpenCatalogi/web-app/blob/e3fdf396cd5fb39266fd77a2af404cb59a881cb7/helm/README.md/"
            >
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
        ...
        <Paragraph className={styles.description}>
          ...
          <span>
            <Link target="_new" to="https://skeleton-app.readthedocs.io/en/latest/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              Read the Docs
          ...
          en is gebaseerd op{" "}
          <span>
            <Link target="_new" to="https://www.mkdocs.org/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              MKDocs
        ...
        <Paragraph>
          ...
          <span>
            <Link target="_new" to="https://www.mkdocs.org/user-guide/installation/">
              <Icon className="utrecht-icon--conduction-start">
                <ExternalLinkIcon />
              </Icon>
              MKDocs installeert
